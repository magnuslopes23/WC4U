...
<body>
    <div class='container'>
        ...
        <div class='container-2' >
            ...
            <a href="event.php"><img class='event-image' src="images/beach.jpg" alt=""></a>
            <a href="event.php"><img class='event-image' src="images/marathon.jpg" alt=""></a> 
      ...
      <div class='container-4'>
        ...
        <div class="contactForm">
          <form method='POST'>
            ...
            <div class='inputBox'>
              <textarea style='background-color:white;color:black' name="feedback" id="" cols="30" rows="10" required></textarea>
